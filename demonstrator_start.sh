...
sleep 3
gnome-terminal -e "bash -c 'cd ~/libfranka/franka_robot_ws/ && source devel/setup.bash && rosrun dtz_demonstration DTZ_LagerDemo'"
sleep 3
gnome-terminal -e "bash -c 'cd ~/libfranka/franka_robot_ws/ && source devel/setup.bash && rosrun dtz_demonstration opc_ua_ros_server.py'"
