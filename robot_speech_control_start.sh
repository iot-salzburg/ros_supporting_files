...
sleep 3
gnome-terminal -e "bash -c 'cd ~/libfranka/rad_ws/src/MultilingualROSSpeechControl && python TTSNode.py'"
sleep 3
gnome-terminal -e "bash -c 'cd ~/libfranka/rad_ws/src/MultilingualROSSpeechControl && python STTNode.py'"
